...
class AcoesApi
{
     ...
     *
     * @param  int $pje_action_id é fornecido após se realizar a requisição de qualquer ação para o Intima.ai (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array
     */
    public function getActionStatus($pje_action_id)
    {
        return $this->getActionStatusWithHttpInfo($pje_action_id);
    }

    /**
     * Operation getActionStatusWithHttpInfo
     *
     * Checa o resultado de uma ação
     *
     * @param  int $pje_action_id é fornecido após se realizar a requisição de qualquer ação para o Intima.ai (required)
     ...
     */
    public function getActionStatusWithHttpInfo($pje_action_id)
    {
        $returnType = '';
        $request = $this->getActionStatusRequest($pje_action_id);
    ...
    /**
     * Operation getActionStatusAsync
     *
     * Checa o resultado de uma ação
     *
     * @param  int $pje_action_id é fornecido após se realizar a requisição de qualquer ação para o Intima.ai (required)
     ...
     */
    public function getActionStatusAsync($pje_action_id)
    {
    ...
    /**
     * Operation getActionStatusAsyncWithHttpInfo
     *
     * Checa o resultado de uma ação
     *
     * @param  int $pje_action_id é fornecido após se realizar a requisição de qualquer ação para o Intima.ai (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getActionStatusAsyncWithHttpInfo($pje_action_id)
    {
        $returnType = '';
        $request = $this->getActionStatusRequest($pje_action_id);
    ...
    /**
     * Create request for operation 'getActionStatus'
     *
     * @param  int $pje_action_id é fornecido após se realizar a requisição de qualquer ação para o Intima.ai (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getActionStatusRequest($pje_action_id)
    {
        ...
        $resourcePath = '/actions/status/{pje_action_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($pje_action_id !== null) {
            $resourcePath = str_replace(
                '{' . 'pje_action_id' . '}',
                ObjectSerializer::toPathValue($pje_action_id),
                $resourcePath
            );
        }
